...
(function (Model) {
  ...
  Model.CAPSClipBoxFace = function (axis, v0, v1, v2, v3, selection) {
    ...
    var backFaceMesh = new THREE.Mesh(
      backFaceGeometry,
      Model.CAPSMATERIAL.BoxBackFace
    );
  ...
  Model.CAPSClipBoxLine = function (v0, v1, f0, f1, selection) {
    ...
    this.line = new THREE.LineSegments(
      lineGeometry,
      Model.CAPSMATERIAL.BoxWireframe
    );
  ...
  Model.CAPSClipBoxLine.prototype = {
    ...
    setHighlight: function (b) {
      this.line.material = b
        ? Model.CAPSMATERIAL.BoxWireActive
        : Model.CAPSMATERIAL.BoxWireframe;
    },
  };
  ...
  Model.CAPSClipping = function (low, high, limitvalue, limitstep) {
    ...
    var f = this.faces;
    this.faces.push(
      new Model.CAPSClipBoxFace("y1", v[0], v[1], v[5], v[4], this)
    );
    this.faces.push(
      new Model.CAPSClipBoxFace("z1", v[0], v[2], v[3], v[1], this)
    );
    this.faces.push(
      new Model.CAPSClipBoxFace("x1", v[0], v[4], v[6], v[2], this)
    );
    this.faces.push(
      new Model.CAPSClipBoxFace("x2", v[7], v[5], v[1], v[3], this)
    );
    this.faces.push(
      new Model.CAPSClipBoxFace("y2", v[7], v[3], v[2], v[6], this)
    );
    this.faces.push(
      new Model.CAPSClipBoxFace("z2", v[7], v[6], v[4], v[5], this)
    );
  ...
  Model.ClipPicking = function (simulation) {
    ...
    simulation.render.domElement.addEventListener(
      "mousemove",
      this.targeting,
      true
    );
  ...
  Model.ClipPicking.prototype = {
    ...
    setEventListener: function (bFlag) {
      ...
      return;
      if (bFlag) {
        this.pSimulation.render.domElement.addEventListener(
          "mousemove",
          this.targeting,
          true
        );
        ...
        this.pSimulation.render.domElement.removeEventListener(
          "mousemove",
          this.targeting,
          true
        );
